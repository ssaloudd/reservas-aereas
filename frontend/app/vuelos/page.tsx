    ...
    <div className="min-h-screen bg-slate-100 p-4 sm:p-6 lg:p-8">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {flights.map((vuelo) => (
            // Se modificaron las clases de estilo para el fondo celeste semitransparente.
            <div key={vuelo.id} className="bg-sky-200/10 backdrop-blur-lg p-6 rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-shadow duration-200">
