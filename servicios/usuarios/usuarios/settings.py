...
SECRET_KEY = 'django-insecure-9n6l=^y4@s9mc=$_m1r-z+=38v6i4md2sry0!p4ugtsbzm4j06'
...
PASSWORD_HASHERS = [
    ...
    #'usuarios.models.CustomSHA256Hasher',  # Si decides crear un hasher personalizado
]
...
SIMPLE_JWT = {
    ...
    'SIGNING_KEY': 'ClaveSuperSecreta123',  # ¡Cambia esto!
    'ALGORITHM': 'HS256',
